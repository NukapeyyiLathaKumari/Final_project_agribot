    ...
    def handle_query(form_data):
        ...
        try:
            ...
            return jsonify({
                ...
                "answer": "The AI embedding service could not start. Check your Python environment and PyTorch installation."
            }), 503
